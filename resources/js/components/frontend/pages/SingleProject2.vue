<template>
  ...
  <div class="container">
    <h1 style="font-size: 5vw !important;">Tongco Residence</h1>
	  <h6>Three-Storey Residence with Basement</h6>
	  <ul>
	  	<li><a href="/">HOME</a></li>
	  	<li><a href="/projects">PROJECTS</a></li>
          <li>Tongco Residence</li>
	  </ul>
  </div>
  <!-- end container --> 
</header>
...
<!-- end content-section -->
    ...
    <div class="row align-items-center">
	  <div class="col-lg-5">
		  <h3><strong>Tongco Residence</strong></h3>
		...
		<div class="col-lg-7">
			<div class="project-specifications">
				<table width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>CLIENT</td>
						<td>Tongco Residence</td>
					</tr>
					<tr>
						<td>DESIGN ARCHITECT</td>
						<td>Arch. ROBERTSON LEE</td>
					</tr>
					<tr>
						<td>SCOPE</td>
					...
					<tr>
						<td>COMPLETED</td>
						<td>November 2015 - November 2017</td>
					</tr>
					<tr>
						<td>SIZE </td>
						<td>500 sq. m floor area</td>
					</tr>
				</table>
			</div>
