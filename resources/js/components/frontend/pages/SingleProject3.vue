<template>
  ...
  <div class="container">
    <h1 style="font-size: 5vw !important;">Robato Residence</h1>
	  <h6>Three-Storey Residence with Basement</h6>
	  <ul>
	  	<li><a href="/">HOME</a></li>
	  	<li><a href="/projects">PROJECTS</a></li>
	  	<li>Robato Residence</li>
	  </ul>
  </div>
  <!-- end container --> 
</header>
...
<section class="content-section no-bottom-spacing">
    ...
    <div class="swiper-wrapper">
      ...
      <!-- end swiper-slide -->
      <div class="swiper-slide">
        <figure class="project-box"> <a href="#"><img src="/template/images/slide03-1.jpg" alt="Image"></a>
          
        </figure>
      </div>
      <!-- end swiper-slide -->
      <div class="swiper-slide">
        <figure class="project-box"> <a href="#"><img src="/template/images/slide03-2.jpg" alt="Image"></a>
        
        </figure>
      </div>
      <div class="swiper-slide">
        <figure class="project-box"> <a href="#"><img src="/template/images/slide03-3.jpg" alt="Image"></a>
        
        </figure>
      </div>
       <div class="swiper-slide">
        <figure class="project-box"> <a href="#"><img src="/template/images/slide03-4.jpg" alt="Image"></a>
...
<!-- end content-section -->
    ...
    <div class="row align-items-center">
	  <div class="col-lg-5">
		  <h3><strong>Robato Residence</strong></h3>
		...
		<div class="col-lg-7">
			<div class="project-specifications">
				<table width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>CLIENT</td>
						<td>Robato Residence</td>
					</tr>
				
					<tr>
						<td>DESIGN ARCHITECT</td>
						<td>Arch. HENRY NG TAN</td>
					</tr>
					<tr>
						<td>SCOPE</td>
...
<!-- end content-section -->	
	<section class="content-section no-spacing white-space-top" data-background="/template/images/section-bg02.jpg">
		<div class="container">
			<div class="row">
				<div class="col-lg-8">
